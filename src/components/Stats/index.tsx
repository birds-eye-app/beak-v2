...
import { parseObservations, Observation } from '@site/src/chirped/parseEbirdExport';
    ...
    return (
      <div style={{ 
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 1rem 0', color: 'var(--ifm-color-primary)' }}>Recent Lifers</h3>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 1rem 0', color: 'var(--ifm-color-primary)' }}>Recent Trip Reports</h3>
